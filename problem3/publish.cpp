// publish.cpp take no arguments
// program send data to ioadafruit website
// e.g. ./publish
#include <iostream>
#include <sstream>
#include <fstream>
...
#define TOPIC      "Bentan01/feeds/remote-control.button"
#define AUTHMETHOD "Bentan01"
#define AUTHTOKEN  "aio_nIRu057WQwkBjOnbJBIYpBOFWKqp"
#define QOS        1
